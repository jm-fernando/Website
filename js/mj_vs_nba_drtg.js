...
svg6.append("circle").attr("cx",80).attr("cy",30).attr("r", 6).style("fill", "#FFC72C")
svg6.append("circle").attr("cx",220).attr("cy",30).attr("r", 6).style("fill", "#1D428A")
svg6.append("text").attr("x", 90).attr("y", 30).text("Coach Jackson").style("font-size", "12px").attr("alignment-baseline","middle")
svg6.append("text").attr("x", 230).attr("y", 30).text("NBA Average").style("font-size", "12px").attr("alignment-baseline","middle")
